...
class StudentList extends StatefulWidget {
  static String id = 'onboadsfsdfsdfrdasdssdasdasdsaddaing';
  @override
...
class _StudentListState extends State<StudentList> {
  ...
  List<String> names = ['Димаш Кудайбергенов','Максат Максатов','Айдана Мейрамбеков'];
  List<String> schools = ['РФМШ','РФМШ','РФМШ'];
