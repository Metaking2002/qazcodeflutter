...
//import 'package:qazaccode/src/util/settings.dart';
//
...
//      setState(() {
//        String info = 'Присоединился к: ' + channel + ', uid: ' + uid.toString();
//        _infoStrings.add(info);
//      });
//    };
//
...
//      setState(() {
//        _infoStrings.add('Покинул комнату');
//        _users.clear();
//      });
//    };
//
...
//      setState(() {
//        String info = 'Участник офлайн: ' + uid.toString();
//        _infoStrings.add(info);
//        _users.remove(uid);
//      });
//    };
